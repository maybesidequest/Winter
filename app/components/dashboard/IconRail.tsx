  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className={`absolute left-0 w-1 rounded-r-full transition-all duration-200 ${isHomeActive
          ...
          style={{
            boxShadow: isHomeActive ? "0 0 10px rgba(129, 117, 238, 0.6)" : undefined,
          }}
        />

        <Link
          to="/dashboard"
          className={`relative flex items-center justify-center w-12 h-12 text-xl font-bold transition-all duration-200 ${isHomeActive
              ? "rounded-2xl bg-[#5b4ccb] text-white ring-2 ring-[#8175ee] scale-105 shadow-lg shadow-black/40"
        ...
        {homeHover && (
          <div
            className="absolute left-[78px] z-50 flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap pointer-events-none transition-opacity duration-150 animate-fadeIn"
            style={{
              background: "rgba(17, 18, 27, 0.95)",
              backdropFilter: "blur(12px)",
              border: "1px solid rgba(255, 255, 255, 0.14)",
              boxShadow: "4px 6px 16px rgba(0, 0, 0, 0.4)",
              color: "#f7f5ef",
            }}
          >
            <span className="font-bold text-white text-[13px]">Dashboard Home</span>
      ...
      {/* Divider */}
      <div className="w-8 h-[2px] my-2 bg-white/10 rounded-full flex-shrink-0" />
      ...
      <div className="w-full flex flex-col items-center gap-1 flex-shrink-0">
        ...
        >
          <button
            ...
            className="flex items-center justify-center w-12 h-12 rounded-3xl bg-[#19172b] text-[#7ed493] hover:bg-[#7ed493] hover:text-[#11121b] hover:rounded-2xl hover:scale-105 transition-all duration-200 border border-white/10 cursor-pointer"
          ...
          {plusHover && (
            <div
              className="absolute left-[78px] z-50 flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap pointer-events-none"
              style={{
                background: "rgba(17, 18, 27, 0.95)",
                backdropFilter: "blur(12px)",
                border: "1px solid rgba(255, 255, 255, 0.14)",
            ...
            >
              <span className="font-bold text-white text-[13px]">
                Create new {instanceType === "hubs" ? "Hub" : "Server"}
              </span>
              <div className="absolute -left-1.5 top-1/2 -translate-y-1/2 w-0 h-0 border-y-[5px] border-y-transparent border-r-[6px] border-r-[rgba(17,18,27,0.95)]" />
            </div>
          )}
        ...
        >
          <span
            className={`absolute left-0 w-1 rounded-r-full transition-all duration-200 ${isBrowseActive
                ? "h-9 bg-[#8175ee] opacity-100 scale-100"
                : browseHover
                  ? "h-5 bg-white/60 opacity-80 scale-100"
                  : "h-2 bg-transparent opacity-0 scale-50"
          ...
          <Link
            to="/dashboard/browse"
            className={`flex items-center justify-center w-12 h-12 text-lg transition-all duration-200 ${isBrowseActive
          ...
          {browseHover && (
            ...
            >
              <span className="font-bold text-white text-[13px]">Explore Hubs</span>
              <div className="absolute -left-1.5 top-1/2 -translate-y-1/2 w-0 h-0 border-y-[5px] border-y-transparent border-r-[6px] border-r-[rgba(17,18,27,0.95)]" />
            </div>
          )}
        </div>
        ...
        >
          <span
            className={`absolute left-0 w-1 rounded-r-full transition-all duration-200 ${isCallsActive
                ? "h-9 bg-[#8175ee] opacity-100 scale-100"
                : callsHover
                  ? "h-5 bg-white/60 opacity-80 scale-100"
                  : "h-2 bg-transparent opacity-0 scale-50"
          ...
          <Link
            to="/dashboard/calls"
            className={`flex items-center justify-center w-12 h-12 text-lg transition-all duration-200 ${isCallsActive
          ...
          {callsHover && (
            ...
            >
              <span className="font-bold text-white text-[13px]">Global Calls</span>
              <div className="absolute -left-1.5 top-1/2 -translate-y-1/2 w-0 h-0 border-y-[5px] border-y-transparent border-r-[6px] border-r-[rgba(17,18,27,0.95)]" />
            </div>
          )}
        </div>
