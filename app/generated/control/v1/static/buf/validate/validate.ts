...
import {
  ...
  fieldDescriptorProto_TypeToNumber,
...
export enum Ignore {
   ...
   */
  IGNORE_IF_ZERO_VALUE = "IGNORE_IF_ZERO_VALUE",
  /**
...
export function ignoreToNumber(object: Ignore): number {
  switch (object) {
...
function createBaseFieldRules(): FieldRules {
  return {
    ...
    cel: [],
    required: false,
    ignore: Ignore.IGNORE_UNSPECIFIED,
    float: undefined,
    double: undefined,
    int32: undefined,
    int64: undefined,
...
export const FieldRules: MessageFns<FieldRules> = {
  encode(message: FieldRules, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ignore !== undefined && message.ignore !== Ignore.IGNORE_UNSPECIFIED) {
      writer.uint32(216).int32(ignoreToNumber(message.ignore));
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 27: {
          ...
          message.ignore = ignoreFromJSON(reader.int32());
          continue;
        }
        case 1: {
          if (tag !== 10) {
  ...
  fromPartial<I extends Exact<DeepPartial<FieldRules>, I>>(object: I): FieldRules {
    ...
    message.cel = object.cel?.map((e) => Rule.fromPartial(e)) || [];
    message.required = object.required ?? false;
    message.ignore = object.ignore ?? Ignore.IGNORE_UNSPECIFIED;
...
export const TimestampRules: MessageFns<TimestampRules> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TimestampRules>, I>>(object: I): TimestampRules {
    const message = createBaseTimestampRules();
    message.const = (object.const !== undefined && object.const !== null)
      ? Timestamp.fromPartial(object.const)
      : undefined;
    message.lt = (object.lt !== undefined && object.lt !== null) ? Timestamp.fromPartial(object.lt) : undefined;
    message.lte = (object.lte !== undefined && object.lte !== null) ? Timestamp.fromPartial(object.lte) : undefined;
    message.ltNow = object.ltNow ?? undefined;
    message.gt = (object.gt !== undefined && object.gt !== null) ? Timestamp.fromPartial(object.gt) : undefined;
    message.gte = (object.gte !== undefined && object.gte !== null) ? Timestamp.fromPartial(object.gte) : undefined;
    ...
    message.within = (object.within !== undefined && object.within !== null)
      ...
      : undefined;
    message.example = object.example?.map((e) => Timestamp.fromPartial(e)) || [];
    return message;
  },
};
...
function createBaseFieldPathElement(): FieldPathElement {
  return {
    fieldNumber: 0,
    fieldName: "",
    fieldType: FieldDescriptorProto_Type.TYPE_DOUBLE,
    keyType: FieldDescriptorProto_Type.TYPE_DOUBLE,
    valueType: FieldDescriptorProto_Type.TYPE_DOUBLE,
    index: undefined,
    boolKey: undefined,
    intKey: undefined,
    uintKey: undefined,
...
export const FieldPathElement: MessageFns<FieldPathElement> = {
  encode(message: FieldPathElement, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fieldType !== undefined && message.fieldType !== FieldDescriptorProto_Type.TYPE_DOUBLE) {
      writer.uint32(24).int32(fieldDescriptorProto_TypeToNumber(message.fieldType));
    }
    if (message.keyType !== undefined && message.keyType !== FieldDescriptorProto_Type.TYPE_DOUBLE) {
      writer.uint32(32).int32(fieldDescriptorProto_TypeToNumber(message.keyType));
    }
    if (message.valueType !== undefined && message.valueType !== FieldDescriptorProto_Type.TYPE_DOUBLE) {
      writer.uint32(40).int32(fieldDescriptorProto_TypeToNumber(message.valueType));
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.fieldType = fieldDescriptorProto_TypeFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.keyType = fieldDescriptorProto_TypeFromJSON(reader.int32());
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.valueType = fieldDescriptorProto_TypeFromJSON(reader.int32());
          continue;
        }
        case 6: {
          if (tag !== 48) {
  ...
  fromPartial<I extends Exact<DeepPartial<FieldPathElement>, I>>(object: I): FieldPathElement {
    ...
    message.fieldType = object.fieldType ?? FieldDescriptorProto_Type.TYPE_DOUBLE;
    message.keyType = object.keyType ?? FieldDescriptorProto_Type.TYPE_DOUBLE;
    message.valueType = object.valueType ?? FieldDescriptorProto_Type.TYPE_DOUBLE;
