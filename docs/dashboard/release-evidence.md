...
| P3-CONTROL | Durable operations, selectors, previews | InterChat `2720242c`, `8cc84ba8`, `960e4076`, `9cf99ba9`; selector suite — 7 passed; operation service suite — 5 passed; targeted Ruff and Pyright passed | InterChat local worktree | implementation owner | 2026-09-01 | passed locally; repository-wide Bot Pyright crashes pre-existing |
...
| P3-OPERATIONS | Durable partial outcomes and service-only progress | InterChat `9cf99ba9`; operation progress accepts terminal `PARTIAL`, emits a durable transition, and rejects human actors; `uv run pytest apps/control_plane/tests/test_operation_service.py -q` — 5 passed | InterChat local worktree | implementation owner | 2026-09-01 | passed locally |
